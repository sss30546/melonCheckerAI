...
def main():
    st.title("Preliminary Lemon Disease Checker Chatbot🍋❄️")
    st.subheader("ให้บรรยายลักษณะภายนอกเลมอน แล้วให้AIช่วยวิเคราะห์ว่าเป็นโรคอะไร")

    if "messages" not in st.session_state:
        st.session_state["messages"] = [
            {"role": "assistant", "content": "สวัสดีจ้า 🍋 ฉันเป็นแชตบอตผู้ช่วยวิเคราะห์โรคในเลมอน 3 โรค ได้แก่ Citrus canker,Citrus scab,Anthracnose บอกฉันได้เลยว่าพบลักษณะแบบไหนโดยอาจใช้ข้อมูล ดังนี้
ผล - ลักษณะแผลบนผล สีของแผล สีของขอบแผล
ใบ - ลักษณะของแผล สีของแผล สีของขอบแผล
กิ่ง/ยอด - ลักษณะของกิ่งหรือยอด
บริเวณที่พบอาการ -  เช่น ลำต้น ใบอ่อน ผลอ่อน ผล เป็นต้น
ลักษณะในท้ายที่สุด - ใบร่วง คุณภาพเลมอนลดลง เป็นต้นแล้วฉันจะช่วยวิเคราะห์ให้นะ"}
        ]
    ...
    for msg in st.session_state["messages"]:
        if msg["role"] == "user":
            ...
            try:
                ...
                st.markdown(f"**🤖 น้องสตางค์:** {msg['content']}")
